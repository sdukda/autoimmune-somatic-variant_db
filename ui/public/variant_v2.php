...
<div class="card">
  ...
  <div class="card">
    ...
    <form method="get" action="/variant_v2.php">
      ...
      <a class="btn-link" href="/variant_v2.php">Clear</a>
    </form>
      ...
      <?php else: ?>
        ...
        <table>
          <tr>
            <th>Gene</th>
            <td>
              <a href="/gene_v2.php?q=<?= urlencode((string)$vsum["gene_symbol"]) ?>">
                <?= h($vsum["gene_symbol"]) ?>
              </a>
            </td>
          </tr>
          <tr><th>Reference genome</th><td><?= na($vsum["ref_genome"] ?? null) ?></td></tr>
    ...
    <div class="card">
      ...
      <?php else: ?>
        <table>
          ...
          <tr><th>Protein</th><td><?= na($detail["protein_change"] ?? null) ?></td></tr>
          ...
          <tr><th>Study short</th><td><?= na($detail["study_name_short"] ?? null) ?></td></tr>
        </table>
