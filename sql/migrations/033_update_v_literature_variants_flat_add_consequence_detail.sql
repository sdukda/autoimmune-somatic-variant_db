...
SELECT
  ...
  /* existing normalized variant_type */
  CASE
  ...
  /* bucketed consequence (what you already have) */
  ldv.variant_impact AS consequence,

  /* NEW: detailed consequence */
  ldv.variant_consequence_detail AS consequence_detail,
